            ...
            <DialogContent className="sm:max-w-md">
                <DialogHeader>
                    ...
                    <DialogDescription className="text-amber-600">
                        No es posible seleccionar transacciones de diferentes fechas en un mismo cierre.
                    </DialogDescription>
                </DialogHeader>
                ...
                <div className="p-4 rounded-lg border border-amber-200 bg-amber-50 dark:border-amber-800/30 dark:bg-amber-900/20 my-2">
                    <div className="space-y-3">
                        <div className="flex justify-between items-center">
                            <span className="text-sm">Fecha actual:</span>
                        ...
                        <div className="flex justify-between items-center">
                            <span className="text-sm">Fecha intentada:</span>
