                                    ...
                                    <FormItem>
                                        ...
                                        <FormDescription>
                                            {newsType === NewsType.LOAN_SPECIFIC
                                                ? "Novedad única: afecta solo a un préstamo específico (vehículo en taller, accidente, etc.)"
                                                : "Novedad general: afecta a toda la tienda (festivos, días libres, mantenimiento del sistema)"}
                                        </FormDescription>
                                        <FormMessage />
                                    </FormItem>
                                )}
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormDescription>
                                            {newsType === NewsType.LOAN_SPECIFIC
                                                ? "Tipo de incidente o situación del vehículo (novedad única)"
                                                : "Tipo de evento que afecta a toda la tienda (novedad general)"}
                                        </FormDescription>
                                        <FormMessage />
                                    </FormItem>
                                )}
