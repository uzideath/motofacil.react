...
export const metadata: Metadata = {
  title: "Recuperar Contraseña | MotoCar de la Costa",
  description: "Recupera tu contraseña del sistema de arrendamientos de motocicletas",
}
        ...
        <div className="bg-gray-900/50 backdrop-blur-md border border-gray-800 rounded-xl shadow-2xl overflow-hidden">
          <div className="p-6">
            <div className="flex flex-col space-y-2 text-center mb-6">
              <h2 className="text-xl font-semibold tracking-tight text-white">Recuperar contraseña</h2>
